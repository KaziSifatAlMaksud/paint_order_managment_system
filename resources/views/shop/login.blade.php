...
<head>
    ...
    <title><?php echo APP_NAME ?> | Shop | Login </title>
        ...
        <div class="page-content vertical-align-middle">
            <div class="brand">
                <!-- <img class="brand-img" width="100px" src="<?php // echo PUBLIC_PATH
                                                                ?>/image/logo.png" alt="..."> -->
                <h2 class="brand-text"><?php //echo APP_NAME 
                                        ?></h2>
            </div>
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="topbar">
                                <h2 class="mt-70"><div class="image-outer">
                                    <img src="<?php echo PUBLIC_PATH ?>/image/logo-phone.png"></div></h2>
                                <p class="color-gray">Login to your Shop account!</p>
                            </div>
                            <div class="mt-70">
                                <div class="row">
                                    <form method="post">
