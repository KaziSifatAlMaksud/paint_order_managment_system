...
<div class="container">
  ...
  <div class="main_nav">
    <br>
<h1><center>Order Paint</center></h1>
    <!-- Sidebar -->
          ...
          <div class="row align-items-center">
            <div class="col-lg-8 col-sm-8 col-8">
              ...
              <li>
                ...
                <a href="<?php echo '/jobs' ?>" class=""><strong>Builders Jobs </strong></a>
                <p>See new job posted by all your builders </p>
              </li>
            </div>
            <div class="col-lg-4 col-sm-4 col-4">
            <a href='/jobs'><img src="/image/Capture.png" alt="User Image">
            </a>
            </div>
          </div>
        </div>
        ...
        <div class="card black-clr-list">
          <div class="row align-items-center">
            <div class="col-lg-8 col-sm-8 col-8">
              ...
              <li>
                <a href="<?php echo '/new_order' ?>" class=""><strong>Buy Paint </strong> </a>
                <p>Buy one can or enter a whole job </p>
              </li>
            </div>
            <div class="col-lg-4 col-sm-4 col-4">
            <a href='/new_order'><img src="/image/order_paint.png" alt="User Image">
            </a>
            </div>
          </div>
        </div>
        ...
        <div class="card black-clr-list">
          <div class="row align-items-center">
            <div class="col-lg-8 col-sm-8 col-8">
              ...
              <li>
                <a href="<?php echo '/photo_order' ?>" class=""><strong>Photo Order</strong></a>
                <p>Just take a photo of the paint can label and tell us how many  </p>
              </li>
            </div>
            <div class="col-lg-4 col-sm-4 col-4">
            <a href='/photo_order'><img src="/image/photo.png" alt="User Image">
            </a>
            </div>
          </div>
        </div>
