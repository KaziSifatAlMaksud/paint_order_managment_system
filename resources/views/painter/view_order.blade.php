                            ...
                            <p><?php echo (@$ordersdetails[0]->price == '0.00') ? 'Price will be declear soon by shop.' : '$' . @$ordersdetails[0]->price; ?></p>
                                    ...
                                    <div class="col-md-6 border_1 border_left half_width">
                                        <p><?php if (@$ordersdetails[0]->pickup == 0) echo 'From Shop';
                                            elseif (@$ordersdetails[0]->pickup == 1) echo '<h4>Deliver To Home</h4>';
                                            else echo '<h4>Deliver To Job Address</h4>'; ?>
                                        </p>
                                    </div>
                                    <!-- job details-->
                                    ...
                                    <div class="col-md-6 border_1 border_left half_width">
                                        <h4><?php echo @$ordersdetails[0]->builder_brand . ' ' . @$ordersdetails[0]->builder_name . ' ' . @$ordersdetails[0]->account_no; ?></h4>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 full-width text-center mt-20">
                                    ...
                                    <div class="example-wrap">
                                        <div class="example table-responsive">
                                            <table class="table table-bordered table-striped table-responsive" id="vieworder">
                                                <thead>
                                                    <tr>
                                                        <th>Product</th>
                                                        <th>Color</th>
    ...
    <div class="display-size ">
        <div class="row card " style="margin-top:10px;margin-left:15px;margin-right:15px !important;border-radius:15px; font-size:18px; border: solid #FEB653;">
            ...
            <div class="col" style="margin-left:10px;">
                ...
                <p class="margin-padding-0"><strong>Customer Name</strong> : <font class=""> <?php echo @$ordersdetails[0]->customer_name; ?></font>
                </p>
        ...
        ?>
            <div class="row card " style="display: flex; justify-content: space-between;margin-top:20px;margin-left:15px;margin-right:15px !important;border-radius:15px;font-size:19px">
                <div class="col-6" style="margin:20px">
                    <span class="">Area : <?php echo $value->area; ?></span><br>
                    <span class=""> <?php echo $value->b_name; ?> : <?php echo $value->color; ?></span><br>
                    <span class=""><?php echo $value->product; ?> </span><br>
                    <span class="">Notes : <?php echo $value->note; ?></span><br>
                </div>
                <div class="col-6" style="margin-left: auto; margin-top:55px; margin-right:35px;color:blcak;">
                    <span> <?php
                            if ($value->size == 101) {
                                echo 'None';
                            } elseif ($value->size == 102) {
