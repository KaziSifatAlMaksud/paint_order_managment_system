        ...
        <div class="card black-clr-list">
          <div class="row align-items-center">
            <div class="col-lg-12 col-sm-12 col-12">
                                            ...
                                            <a class=" " href="real_show_invoice/<?php echo $value->id; ?>">
                                                <?php echo $value->address ? $value->address : $user->address; ?>
                                            </a>
                                        
                                        <p class="middle data-ord">{{ $value->created_at ? \Carbon\Carbon::parse($value->created_at)->format('d/m/Y') : '' }}</p>
           ...
           <!-- <a href='/real_show_invoice'><img src="/image/rgrg.png" alt="User Image">  -->
            </a>
            </div>
          </div>
        </div>
