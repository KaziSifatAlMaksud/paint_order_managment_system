        ...
        <div class="card black-clr-list">
          <div class="row align-items-center">
            <div class="col-lg-8 col-sm-8 col-8">
              ...
              <li>
                <a href="<?php echo '/real_profile' ?>" class=""><strong>Edit Profile</strong></a>
                <p>Change your personal details </p>
              </li>
            </div>
            <div class="col-lg-4 col-sm-4 col-4">
            <a href='/real_profile'><img src="/image/user.png" alt="User Image">
            </a>
            </div>
          </div>
        </div>
        ...
        <div class="card black-clr-list">
          <div class="row align-items-center">
            <div class="col-lg-8 col-sm-8 col-8">
              ...
              <li>
                <a href="<?php echo '/see_paint_account' ?>" class=""><strong>Paint Accounts</strong> </a>
                <p>Change or add your paint account details </p>
              </li>
            </div>
            <div class="col-lg-4 col-sm-4 col-4">
            <a href='/see_paint_account'><img src="/image/paint_accounts.png" alt="User Image">
            </a>
            </div>
          </div>
        </div>
        ...
        <div class="card black-clr-list">
          <div class="row align-items-center">
            <div class="col-lg-8 col-sm-8 col-8">
              ...
              <li>
                <a href="<?php echo '/accounts' ?>" class=""><strong>Conect To builders</strong></a>
                <p>Connet this app to the builders you work for, we do the rest </p>
              </li>
            </div>
            <div class="col-lg-4 col-sm-4 col-4">
            <a href='/accounts'><img src="/image/builders.png" alt="User Image">
            </a>
            </div>
          </div>
        </div>
